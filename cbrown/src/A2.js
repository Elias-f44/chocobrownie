...
function A2() {
  ...
  function calculateTimeLeft() {
    const targetDate = new Date("2024-11-22T00:00:00"); // Target date
    const now = new Date();
  ...
  if (!isVisible) {
    return (
      <div className="countdown-container">
        <h1>This will be visible on 18/11/2024.</h1>
        {timeLeft && (
          <p>
  ...
  return (
    <div className="content-container">
      <h1 className="assignment-title">A2 Assignment Page</h1>
